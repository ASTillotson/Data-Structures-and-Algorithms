...
public class LinkedIntList {
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        LinkedIntList ans = new LinkedIntList();
        ListNode aIterator = A.front;
        ListNode ansIterator = A.front;
        if (aIterator != null) {
            ListNode first = new ListNode(aIterator.data);
            ans.front = first;
            ansIterator = ans.front;
            aIterator = aIterator.next;
        }
        while (aIterator != null) {
            ListNode temp = new ListNode(aIterator.data);
            ansIterator.next = temp;
